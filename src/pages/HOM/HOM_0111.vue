...
<template>
	<div>
		...
		<div class="likes-list-page">
			...
			<section>
				<div class="card-id-wrap" v-for="item in likes">
					<!-- User Profile Image -->
					<div class="profile-wrap" :style="`background-image: url(${item.profileImg});`"></div>
					...
					<div class="l-column" style="width: 100%">
						...
						<div class="user-badge-created-time-wrap">
							...
							<span class="card-caption-2" v-show="item.createdAt">|</span>
							<span class="card-caption-1" v-show="item.createdAt">{{ item.createdAt }}</span>
						</div>
					</div>
					<!-- Like image -->
